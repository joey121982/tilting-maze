...
// Register Addresses           XxxxxxXx <----- make sure to change capital X values for daisy-chain configuration on 2nd LSB
//                                              and for read (0) / write & clear (1) on MSB
